...
import { getIngredients, postIngredient, getUnits } from "../actions/index";
  ...
  return (
    <div className="ingredientCreatorContent">
      <div className="ingredientCreator">
        <h1 className="titleIngredientCreator">Crear ingrediente</h1>
        <form onSubmit={(e) => handleSubmit(e)}>
          <div className="ingredientInputs">
            ...
            <div className="ingredientUnit">
              ...
              <select className="input2" onChange={(e) => handleSelect(e)}>
        ...
        <div className="messagesContentIngredientCreator">
          ...
          {/* <div>
              <Modal isOpen={show}>
                <ModalHeader>Ingredientes existentes</ModalHeader>
                <ModalBody>
                {intermedio.length &&
                  intermedio?.map((ing) => (
